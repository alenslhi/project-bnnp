            ...
            <div class="relative">
                <div class="aspect-square rounded-3xl bg-gradient-to-br from-primary-600/20 to-accent-600/20 border border-white/5 flex items-center justify-center">
                    <div class="text-center p-8">
                        <div class="flex h-20 w-20 mx-auto items-center justify-center rounded-2xl bg-gradient-to-br from-primary-500 to-primary-700 shadow-2xl shadow-primary-500/25 mb-6">
